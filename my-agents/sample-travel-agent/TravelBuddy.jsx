    ...
    <div className="fixed bottom-4 right-4 z-50">
      <div className="w-80 h-96 bg-white border rounded-lg shadow-xl">
        <div className="flex items-center justify-between p-4 border-b bg-blue-600 text-white rounded-t-lg">
          <h3 className="font-semibold">Travel Buddy</h3>
          ...
          {messages.length === 0 && (
            <div className="bg-blue-50 p-3 rounded-lg mb-4">
              <div className="text-sm text-blue-800">
                Hi! I'm Travel Buddy. I can help you plan amazing trips and find the best travel experiences. Where would you like to go?
              </div>
            </div>
          )}
